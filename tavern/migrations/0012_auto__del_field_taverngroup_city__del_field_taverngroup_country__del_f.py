...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TavernGroup.city'
        db.delete_column(u'tavern_taverngroup', 'city')

        # Deleting field 'TavernGroup.country'
        db.delete_column(u'tavern_taverngroup', 'country')

        # Deleting field 'TavernGroup.group_type'
        db.delete_column(u'tavern_taverngroup', 'group_type')


        # Changing field 'TavernGroup.members_name'
        db.alter_column(u'tavern_taverngroup', 'members_name', self.gf('django.db.models.fields.CharField')(default='', max_length=40))

    def backwards(self, orm):
        # Adding field 'TavernGroup.city'
        db.add_column(u'tavern_taverngroup', 'city',
                      self.gf('django.db.models.fields.CharField')(default='Hyderabad', max_length=20),
                      keep_default=False)

        # Adding field 'TavernGroup.country'
        db.add_column(u'tavern_taverngroup', 'country',
                      self.gf('django.db.models.fields.CharField')(default='India', max_length=20),
                      keep_default=False)

        # Adding field 'TavernGroup.group_type'
        db.add_column(u'tavern_taverngroup', 'group_type',
                      self.gf('django.db.models.fields.CharField')(default='dev', max_length=100),
                      keep_default=False)


        # Changing field 'TavernGroup.members_name'
        db.alter_column(u'tavern_taverngroup', 'members_name', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
