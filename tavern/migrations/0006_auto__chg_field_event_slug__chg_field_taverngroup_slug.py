...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tavern_event', 'slug', self.gf('django.db.models.fields.SlugField')(default=0, max_length=250))

        # Changing field 'TavernGroup.slug'
        db.alter_column(u'tavern_taverngroup', 'slug', self.gf('django.db.models.fields.SlugField')(default=0, max_length=50))

    def backwards(self, orm):

        # Changing field 'Event.slug'
        db.alter_column(u'tavern_event', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=250, null=True))

        # Changing field 'TavernGroup.slug'
        db.alter_column(u'tavern_taverngroup', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
