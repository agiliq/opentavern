...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.starts_at'
        db.alter_column(u'tavern_event', 'starts_at', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.starts_at'
        db.alter_column(u'tavern_event', 'starts_at', self.gf('django.db.models.fields.DateTimeField')(default=0))
