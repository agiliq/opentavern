...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.end_at'
        db.delete_column(u'tavern_event', 'end_at')

        # Adding field 'Event.ends_at'
        db.add_column(u'tavern_event', 'ends_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Event.end_at'
        db.add_column(u'tavern_event', 'end_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Event.ends_at'
        db.delete_column(u'tavern_event', 'ends_at')
