...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Attendee.member'
        db.delete_column(u'tavern_attendee', 'member_id')


    def backwards(self, orm):
        # Adding field 'Attendee.member'
        db.add_column(u'tavern_attendee', 'member',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tavern.Membership']),
                      keep_default=False)
